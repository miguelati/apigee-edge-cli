...
class Command {
	static showHeaderApiproxy() {
		...
		console.log(global.chalk.gray.bold("ApiProxy: ") + global.chalk.blue.bold(info.name));
		console.log(global.chalk.gray.bold("Revision: ") + global.chalk.blue.bold(info.revision));
		console.log("\n");
	}
