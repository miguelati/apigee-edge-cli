...
class Watcher {
	...
	constructor(vorpal) {
		...
		if(_.has(global.prefs, 'live.validation') && global.prefs.live.validation && fs.existsSync(`./${global.actualRevision}/apiproxy/`)) this._paths.push(`./${global.actualRevision}/apiproxy/`);
		this.start();
	}
