	...
	static injectCommand(vorpal) {
		...
		vorpal.command('targetEndpoint preflow <targetEndpointName>', 'Show preflow graph')
			...
			.action((args, callback) => {
				...
				console.log(FlowDrawer.draw("request", targetEndpointHelper.getPreFlowRequestStepNames()));
				console.log(FlowDrawer.draw("response", targetEndpointHelper.getPreFlowResponseStepNames()));
		...
		vorpal.command('targetEndpoint postflow <targetEndpointName>', 'Show postflow graph')
			...
			.action((args, callback) => {
		    	...
		    	console.log(FlowDrawer.draw("request", targetEndpointHelper.getPostFlowRequestStepNames()));
		    	console.log(FlowDrawer.draw("response", targetEndpointHelper.getPostFlowResponseStepNames()));
