	...
	static injectCommand(vorpal) {
		...
		vorpal.command('proxyEndpoint preflow <proxyEndpointName>', 'Show preflow graph')
			...
			.action((args, callback) => {
				...
				console.log(FlowDrawer.draw("request", proxyEndpointHelper.getPreFlowRequestStepNames()));
				console.log(FlowDrawer.draw("response", proxyEndpointHelper.getPreFlowResponseStepNames()));
		...
		vorpal.command('proxyEndpoint postflow <proxyEndpointName>', 'Show postflow graph')
			...
			.action((args, callback) => {
		    	...
		    	console.log(FlowDrawer.draw("request", proxyEndpointHelper.getPostFlowRequestStepNames()));
		    	console.log(FlowDrawer.draw("response", proxyEndpointHelper.getPostFlowResponseStepNames()));
